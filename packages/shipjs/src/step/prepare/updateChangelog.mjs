...
import { parseArgs } from '../../util/index.mjs';
...
// https://github.com/conventional-changelog/conventional-changelog/blob/master/packages/conventional-changelog-cli/cli.mjs
const argSpec = {
  '--infile': String,
  '--outfile': String,
  '--same-file': Boolean,
