  ...
  describe('formatPullRequestMessage', () => {
    ...
    it('gets message for release branch strategy', () => {
      ...
      expect(message).toMatchInlineSnapshot(`
        ...
        | Package | Branch | Update | Change |
        |---|---|---|---|
        | [shipjs](https://github.com/algolia/shipjs) | master → releases/v0.1.1 (current) → release/stable | patch | [\`0.1.0\` → \`0.1.1\`](https://github.com/algolia/shipjs/compare/v0.1.0...releases/v0.1.1) |
        ...
        ### Merging Instructions
        When merging this pull request, you need to **Merge pull request(Create a merge commit)** and also, you **must modify** the title to start with \`chore: release v0.1.1\`.
        <details>
        <summary>See details</summary>
